...
data class DetailGameResponse(
	...
	fun toDetailGame(): List<DetailGame>{
		return listOf(DetailGame(id.toString(), name, publishers.map {it.name}.get(0),backgroundImage,descriptionRaw,released,rating.toString(),playtime.toString(),false))
	}
